...
namespace AU_UAV_ROS{
	...
	AU_UAV_ROS::waypointContainer findNewWaypoint(PlaneObject &plane1, std::map<int, PlaneObject> &planes);//, AU_UAV_ROS::waypoint curDest);
	...
	void getCone(PlaneObject plane1, PlaneObject plane2, double *N);
