...
(defsystem "AU_UAV_ROS-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "ClearCollisionAvoidance" :depends-on ("_package_ClearCollisionAvoidance"))
    (:file "_package_ClearCollisionAvoidance" :depends-on ("_package"))
    (:file "SaveFlightData" :depends-on ("_package_SaveFlightData"))
    (:file "_package_SaveFlightData" :depends-on ("_package"))
    (:file "ClearSimulator" :depends-on ("_package_ClearSimulator"))
    (:file "_package_ClearSimulator" :depends-on ("_package"))
    ...
    (:file "ClearCoordinator" :depends-on ("_package_ClearCoordinator"))
    (:file "_package_ClearCoordinator" :depends-on ("_package"))
