...
(cl:defmethod cl:initialize-instance :after ((m <RequestWaypointInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestWaypointInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<RequestWaypointInfo-request> is deprecated: use AU_UAV_Team1-srv:RequestWaypointInfo-request instead.")))

(cl:ensure-generic-function 'planeID-val :lambda-list '(m))
(cl:defmethod planeID-val ((m <RequestWaypointInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:planeID-val is deprecated.  Use AU_UAV_Team1-srv:planeID instead.")
  (planeID m))
...
(cl:defmethod isAvoidanceWaypoint-val ((m <RequestWaypointInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:isAvoidanceWaypoint-val is deprecated.  Use AU_UAV_Team1-srv:isAvoidanceWaypoint instead.")
...
(cl:defmethod positionInQueue-val ((m <RequestWaypointInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:positionInQueue-val is deprecated.  Use AU_UAV_Team1-srv:positionInQueue instead.")
  (positionInQueue m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestWaypointInfo-request>)))
  ...
  "AU_UAV_Team1/RequestWaypointInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestWaypointInfo-request)))
  "Returns string type for a service object of type 'RequestWaypointInfo-request"
  "AU_UAV_Team1/RequestWaypointInfoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RequestWaypointInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestWaypointInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<RequestWaypointInfo-response> is deprecated: use AU_UAV_Team1-srv:RequestWaypointInfo-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <RequestWaypointInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:error-val is deprecated.  Use AU_UAV_Team1-srv:error instead.")
  (error m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <RequestWaypointInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:latitude-val is deprecated.  Use AU_UAV_Team1-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <RequestWaypointInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:longitude-val is deprecated.  Use AU_UAV_Team1-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <RequestWaypointInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:altitude-val is deprecated.  Use AU_UAV_Team1-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestWaypointInfo-response>)))
  ...
  "AU_UAV_Team1/RequestWaypointInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestWaypointInfo-response)))
  "Returns string type for a service object of type 'RequestWaypointInfo-response"
  "AU_UAV_Team1/RequestWaypointInfoResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestWaypointInfo)))
  ...
  "AU_UAV_Team1/RequestWaypointInfo")