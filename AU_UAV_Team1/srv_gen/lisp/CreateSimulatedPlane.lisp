...
(cl:defmethod cl:initialize-instance :after ((m <CreateSimulatedPlane-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CreateSimulatedPlane-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<CreateSimulatedPlane-request> is deprecated: use AU_UAV_Team1-srv:CreateSimulatedPlane-request instead.")))
...
(cl:defmethod startingLatitude-val ((m <CreateSimulatedPlane-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:startingLatitude-val is deprecated.  Use AU_UAV_Team1-srv:startingLatitude instead.")
  (startingLatitude m))
...
(cl:defmethod startingLongitude-val ((m <CreateSimulatedPlane-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:startingLongitude-val is deprecated.  Use AU_UAV_Team1-srv:startingLongitude instead.")
  (startingLongitude m))
...
(cl:defmethod startingAltitude-val ((m <CreateSimulatedPlane-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:startingAltitude-val is deprecated.  Use AU_UAV_Team1-srv:startingAltitude instead.")
  (startingAltitude m))
...
(cl:defmethod startingBearing-val ((m <CreateSimulatedPlane-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:startingBearing-val is deprecated.  Use AU_UAV_Team1-srv:startingBearing instead.")
  (startingBearing m))

(cl:ensure-generic-function 'requestedID-val :lambda-list '(m))
(cl:defmethod requestedID-val ((m <CreateSimulatedPlane-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:requestedID-val is deprecated.  Use AU_UAV_Team1-srv:requestedID instead.")
  (requestedID m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CreateSimulatedPlane-request>)))
  ...
  "AU_UAV_Team1/CreateSimulatedPlaneRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CreateSimulatedPlane-request)))
  "Returns string type for a service object of type 'CreateSimulatedPlane-request"
  "AU_UAV_Team1/CreateSimulatedPlaneRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CreateSimulatedPlane-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CreateSimulatedPlane-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<CreateSimulatedPlane-response> is deprecated: use AU_UAV_Team1-srv:CreateSimulatedPlane-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CreateSimulatedPlane-response>)))
  ...
  "AU_UAV_Team1/CreateSimulatedPlaneResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CreateSimulatedPlane-response)))
  "Returns string type for a service object of type 'CreateSimulatedPlane-response"
  "AU_UAV_Team1/CreateSimulatedPlaneResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CreateSimulatedPlane)))
  ...
  "AU_UAV_Team1/CreateSimulatedPlane")