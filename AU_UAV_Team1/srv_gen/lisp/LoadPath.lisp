...
(cl:defmethod cl:initialize-instance :after ((m <LoadPath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadPath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<LoadPath-request> is deprecated: use AU_UAV_Team1-srv:LoadPath-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <LoadPath-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:filename-val is deprecated.  Use AU_UAV_Team1-srv:filename instead.")
  (filename m))
...
(cl:defmethod cl:initialize-instance :after ((m <LoadPath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadPath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<LoadPath-response> is deprecated: use AU_UAV_Team1-srv:LoadPath-response instead.")))
