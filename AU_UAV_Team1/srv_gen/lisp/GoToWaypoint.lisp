...
(cl:defmethod cl:initialize-instance :after ((m <GoToWaypoint-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoToWaypoint-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<GoToWaypoint-request> is deprecated: use AU_UAV_Team1-srv:GoToWaypoint-request instead.")))
...
(cl:defmethod isAvoidanceManeuver-val ((m <GoToWaypoint-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:isAvoidanceManeuver-val is deprecated.  Use AU_UAV_Team1-srv:isAvoidanceManeuver instead.")
...
(cl:defmethod isNewQueue-val ((m <GoToWaypoint-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-srv:isNewQueue-val is deprecated.  Use AU_UAV_Team1-srv:isNewQueue instead.")
  (isNewQueue m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GoToWaypoint-request>)))
  ...
  "AU_UAV_Team1/GoToWaypointRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GoToWaypoint-request)))
  "Returns string type for a service object of type 'GoToWaypoint-request"
  "AU_UAV_Team1/GoToWaypointRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GoToWaypoint-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoToWaypoint-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-srv:<GoToWaypoint-response> is deprecated: use AU_UAV_Team1-srv:GoToWaypoint-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GoToWaypoint-response>)))
  ...
  "AU_UAV_Team1/GoToWaypointResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GoToWaypoint-response)))
  "Returns string type for a service object of type 'GoToWaypoint-response"
  "AU_UAV_Team1/GoToWaypointResponse")
