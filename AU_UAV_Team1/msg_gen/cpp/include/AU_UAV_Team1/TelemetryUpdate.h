/* Auto-generated by genmsg_cpp for file /home/phil/fuerte_workspace/sandbox/AU_UAV_Team1/msg/TelemetryUpdate.msg */
#ifndef AU_UAV_TEAM1_MESSAGE_TELEMETRYUPDATE_H
#define AU_UAV_TEAM1_MESSAGE_TELEMETRYUPDATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TelemetryUpdate_ {
  ...
  typedef boost::shared_ptr< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct TelemetryUpdate
typedef  ::AU_UAV_Team1::TelemetryUpdate_<std::allocator<void> > TelemetryUpdate;

typedef boost::shared_ptr< ::AU_UAV_Team1::TelemetryUpdate> TelemetryUpdatePtr;
typedef boost::shared_ptr< ::AU_UAV_Team1::TelemetryUpdate const> TelemetryUpdateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "53cd950963d7a5c403c785f8c0a2ffa7";
  }

  static const char* value(const  ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x53cd950963d7a5c4ULL;
  static const uint64_t static_value2 = 0x03c785f8c0a2ffa7ULL;
};

template<class ContainerAllocator>
struct DataType< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "AU_UAV_Team1/TelemetryUpdate";
  }
...
template<class ContainerAllocator>
struct Definition< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::AU_UAV_Team1::TelemetryUpdate_<ContainerAllocator> & v) 
  {
...
#endif // AU_UAV_TEAM1_MESSAGE_TELEMETRYUPDATE_H
