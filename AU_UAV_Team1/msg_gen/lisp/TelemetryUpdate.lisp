...
(cl:in-package AU_UAV_Team1-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TelemetryUpdate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TelemetryUpdate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_Team1-msg:<TelemetryUpdate> is deprecated: use AU_UAV_Team1-msg:TelemetryUpdate instead.")))

(cl:ensure-generic-function 'telemetryHeader-val :lambda-list '(m))
(cl:defmethod telemetryHeader-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:telemetryHeader-val is deprecated.  Use AU_UAV_Team1-msg:telemetryHeader instead.")
  (telemetryHeader m))

(cl:ensure-generic-function 'planeID-val :lambda-list '(m))
(cl:defmethod planeID-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:planeID-val is deprecated.  Use AU_UAV_Team1-msg:planeID instead.")
  (planeID m))

(cl:ensure-generic-function 'currentLatitude-val :lambda-list '(m))
(cl:defmethod currentLatitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:currentLatitude-val is deprecated.  Use AU_UAV_Team1-msg:currentLatitude instead.")
  (currentLatitude m))

(cl:ensure-generic-function 'currentLongitude-val :lambda-list '(m))
(cl:defmethod currentLongitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:currentLongitude-val is deprecated.  Use AU_UAV_Team1-msg:currentLongitude instead.")
  (currentLongitude m))

(cl:ensure-generic-function 'currentAltitude-val :lambda-list '(m))
(cl:defmethod currentAltitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:currentAltitude-val is deprecated.  Use AU_UAV_Team1-msg:currentAltitude instead.")
  (currentAltitude m))

(cl:ensure-generic-function 'destLatitude-val :lambda-list '(m))
(cl:defmethod destLatitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:destLatitude-val is deprecated.  Use AU_UAV_Team1-msg:destLatitude instead.")
  (destLatitude m))

(cl:ensure-generic-function 'destLongitude-val :lambda-list '(m))
(cl:defmethod destLongitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:destLongitude-val is deprecated.  Use AU_UAV_Team1-msg:destLongitude instead.")
  (destLongitude m))

(cl:ensure-generic-function 'destAltitude-val :lambda-list '(m))
(cl:defmethod destAltitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:destAltitude-val is deprecated.  Use AU_UAV_Team1-msg:destAltitude instead.")
  (destAltitude m))

(cl:ensure-generic-function 'groundSpeed-val :lambda-list '(m))
(cl:defmethod groundSpeed-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:groundSpeed-val is deprecated.  Use AU_UAV_Team1-msg:groundSpeed instead.")
  (groundSpeed m))

(cl:ensure-generic-function 'targetBearing-val :lambda-list '(m))
(cl:defmethod targetBearing-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:targetBearing-val is deprecated.  Use AU_UAV_Team1-msg:targetBearing instead.")
  (targetBearing m))

(cl:ensure-generic-function 'currentWaypointIndex-val :lambda-list '(m))
(cl:defmethod currentWaypointIndex-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:currentWaypointIndex-val is deprecated.  Use AU_UAV_Team1-msg:currentWaypointIndex instead.")
...
(cl:defmethod distanceToDestination-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_Team1-msg:distanceToDestination-val is deprecated.  Use AU_UAV_Team1-msg:distanceToDestination instead.")
